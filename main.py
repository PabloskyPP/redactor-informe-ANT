"""
Programa principal para generar informe del test ANT
"""
import sys
import os
...
def main():
    ...
    print("=" * 70)
    print("GENERADOR DE INFORME ANT")
    print("=" * 70)
    print()
    ...
    try:
        ...
        print(f"    Puntuación directa O: {resultados['PD_O']}")
        print(f"    Puntuación directa F_A (errores): {resultados['PD_F_A']}")
        print(f"    Puntuación directa TR: {resultados['PD_TR']}")
        print(f"    Puntuación directa F_TR (tiempo de respuesta): {resultados['PD_F_TR']}")
        print(f"    Puntuación directa Alerta: {resultados['PD_TR_alerta']}")
        print(f"    Puntuación directa Orientación: {resultados['PD_TR_orientacion']}")
        print(f"    Puntuación directa Ejecutivo: {resultados['PD_TR_ejecutivo']}")
    ...
    try:
        ...
        print(f"    PT_A: {resultados['PT_A']} (Clasificación: {resultados['Clasificacion_A']})")
        print(f"    PT_C: {resultados['PT_C']} (Clasificación: {resultados['Clasificacion_C']})")
        print(f"    PT_O: {resultados['PT_O']} (Clasificación: {resultados['Clasificacion_O']})")
        print(f"    PT_F_A: {resultados['PT_F_A']} (Clasificación: {resultados['Clasificacion_F_A']})")
        print(f"    Clasificación TR: {resultados['Clasificacion_TR']}")
        print(f"    PT_F_TR: {resultados['PT_F_TR']} (Clasificación: {resultados['Clasificacion_F_TR']})")
        print(f"    PT_TR_alerta: {resultados['PT_TR_alerta']} (Clasificación: {resultados['Clasificacion_TR_alerta']})")
        print(f"    PT_TR_orientacion: {resultados['PT_TR_orientacion']} (Clasificación: {resultados['Clasificacion_TR_orientacion']})")
        print(f"    PT_TR_ejecutivo: {resultados['PT_TR_ejecutivo']} (Clasificación: {resultados['Clasificacion_TR_ejecutivo']})")
