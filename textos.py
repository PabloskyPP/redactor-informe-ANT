...
- Red de control ejecutivo. Se encarga de inhibir información distractora, inhibir conductas habituales cuando no son necesarias y de monitorizar nuestra conducta de manera que podamos adaptarnos a las circunstancias cambiantes que se nos presentan en el entorno. Se pone en marcha en situaciones de procesamiento complejo y controlado.
...
PARRAFO_A = {
    ...
    'A bajo':"""En primer lugar, {nombre} muestra un porcentaje de aciertos bajo, lo que indica complicaciones para completar eficientemente la tarea presentada. Según este resultado, la capacidad atencional general resulta inferior a la media para su edad.""",

    'A normal':"""En primer lugar, {nombre} muestra un porcentaje de aciertos normal, lo que indica una capacidad atencional general adecuada a la esperada para su edad.""",
    
    'A alto':"""En primer lugar, {nombre} muestra un porcentaje de aciertos alto, lo que indica una capacidad atencional general superior a la media para su edad.""",
}

PARRAFO_C = {

    'C bajo':"""Respecto al número de errores de comisión, este fue bajo, lo que señala que pocas veces emite una respuesta errónea. Este resultado señala una capacidad superior al promedio para discriminar la información de manera eficiente y una muy baja impulsividad. Así, esto podría ser también un indicador de la preferencia por un estilo atencional más reflexivo, con respuestas más lentas pero más precisas.""",
    ...
    'C alto':"""Respecto al número de errores de comisión, este fue alto, lo que señala que emite un número de respuestas erróneas superior a lo esperado para su edad. Este resultado puede señalar dos cosas: una capacidad inferior al promedio para discriminar la información de manera eficiente, y/o un nivel de impulsividad superior al esperado para su edad.""",
}

PARRAFO_TR_A_vs_C = {
'TR_A_vs_C positivo':"""Si miramos al tiempo de respuesta en relación a la precisión, vemos que los errores de comisión de {nombre} acontecen a una mayor velocidad de respuesta en comparación con los aciertos. Esto señala que el problema atencional está especialmente vinculado a la elevada impulsividad de {nombre}, con respuestas más rápidas pero menos precisas.""",
'TR_A_vs_C negativo':"""Si miramos al tiempo de respuesta en relación a la precisión, vemos que los errores de comisión de {nombre} acontecen a una menor velocidad de respuesta en comparación con los aciertos. Esto señala que el problema atencional no está propiamente vinculado a la impulsividad, sino a importantes dificultades perceptivas y en el procesamiento de la información, que incapacitan a {nombre} a discriminar la información de manera eficiente.""",
