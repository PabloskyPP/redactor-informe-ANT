...
PARRAFO_C = {
    ...
    'C bajo':"""{nombre} presenta un número de errores de comisión bajo, lo que señala que pocas veces emite una respuesta errónea. Este resultado señala una capacidad superior al promedio para discriminar la información de manera eficiente y una muy baja impulsividad. Así, esto podría ser también un indicador de la preferencia por un estilo atencional más reflexivo, con respuestas más lentas pero más precisas.""",

    'C normal':"""{nombre} presenta un número de errores de comisión normal, lo que señala que emite un número de respuestas erróneas igual a lo esperado para su edad. Este resultado señala a la hora de tomar una capacidad adecuada para discriminar la información de manera eficiente y un nivel de impulsividad igual al esperado para su edad.""",

    'C alto':"""{nombre} presenta un número de errores de comisión alto, lo que señala que emite un número de respuestas erróneas superior a lo esperado para su edad. Este resultado señala una capacidad inferior al promedio para discriminar la información de manera eficiente y un nivel de impulsividad superior al esperado para su edad. Así, esto podría ser también un indicador de la preferencia por un estilo atencional más impulsivo, con respuestas más rápidas pero menos precisas.""",
}

PARRAFO_O = {
    'O bajo':"""{nombre} presenta un número de errores de omisión bajo, lo que señala que pocas veces no ha respondido cuando debería. Este resultado puede señalar una velocidad de procesamiento de la información y de toma de decisiones bien ajustada a la exigencia temporal de la tarea. Otra explicación puede ser debido a una capacidad superior al promedio para mantener la atención sostenida a lo largo de la tarea, sin distraerse o fatigarse, de manera que se le dificulte emitir una respuesta en los momentos oportunos.""",

    'O normal':"""{nombre} presenta un número de errores de omisión normal, lo que señala que no ha respondido cuando debería un número de veces igual a lo esperado para su edad. Este resultado puede señalar una velocidad de procesamiento de la información y toma de decisiones adecuada a la exigencia temporal de la tarea. Este índice también puede señalar una capacidad adecuada para mantener la atención sostenida a lo largo de la tarea, sin distraerse o fatigarse demasiado, de manera que se le dificulte emitir una respuesta en los momentos oportunos.""",
...
PARRAFO_F = {
    ...
    'F_A normal y F_TR normal':"""{nombre} muestra un rendimiento sumamente constante a lo largo de la prueba, sin que su precisión y velocidad de respuesta se vean afectadas. Esto indica una excelente capacidad de atención sostenida y resistencia a la fatiga, incluso, o especialmente, ante tareas simples y monótonas como esta.""",
