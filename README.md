# Generador de Informes de la prueba de redes atencionales ANT

Este programa procesa los datos de la tarea ANT y genera un informe profesional en formato Word (.docx) y PDF.
...
```python
RUTA_EXCEL = r"C:\Users\Yo\OneDrive\Escritorio\data\ejemplo.xlsx"
NOMBRE_CASO = "Ejemplo"  # Nombre de fallback si no está en el Excel
...
- `Informe_ANT_Resultado.docx` - Informe en formato Word
- `Informe_ANT_Resultado.pdf` - Informe en formato PDF
...
- Verificar que la hoja "Ant" tiene todas las columnas requeridas
...
Los baremos se obtuvieron de un estudio normativo propio y no publicado. Estos datos se consiguieron empleando el procedimiento original de la prueba (Fan y cols., 2002). Un estudio de referencia que intenta obtener datos normativos para población española se puede consultar en el siguiente enlace:
https://crea.ujaen.es/server/api/core/bitstreams/71440c8a-44ab-4aaf-9380-14d0dfa0492f/content
