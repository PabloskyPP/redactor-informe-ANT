...
BAREMOS_BASE = {
    ...
    58: {"A": 135, "C": 179,"O": 179,"F_A": 179,"F_TR" :  	" TR_alerta" :  	" TR_orientacion" :  	" TR_ejecutivo" :
    ...
    # ... (continuar con los demás baremos)
    ...
    32: {"A": 83,   "C": 179,"O": 179,"F_A": 179,"F_TR" :  	" TR_alerta" :  	" TR_orientacion" :  	" TR_ejecutivo" :
    # ... (continuar con los demás baremos)
...
def obtener_ajuste_edad(edad):
    ...
    """
    if 16 <= edad <= 44:
        return {"A": 0, "TR": 0, "TR_alerta": 0, "TR_orientacion": 0, "TR_ejecutivo": 0}
    elif 45 <= edad <= 64:
        return {"A": -8, "TR": -4, "TR_alerta": -5, "TR_orientacion": 0, "TR_ejecutivo": 0}
    elif edad >= 65:
        return {"A": -14, "TR": -11, "TR_alerta": -15, "TR_orientacion": 0, "TR_ejecutivo": 0}
    else:
...
def obtener_puntuaciones_tipicas(resultados):
    ...
    # Procesar cada índice (A, TR, TR_alerta, TR_orientacion, TR_ejecutivo)
    indices = ['A', 'TR', 'TR_alerta', 'TR_orientacion', 'TR_ejecutivo']
